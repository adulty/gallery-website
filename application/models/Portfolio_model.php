...
class Portfolio_model extends CI_Model {
	...
	public function getAllFolios($page)
	{
		$this->db->from('portfolios');
		$this->db->where('is_active', 'Y');
		$this->paginate($page);
	...
	{
		return $this->db->get_where('portfolios', ['id' => $id])->row();
	}

	public function getDataBySeo($seo_title)
	{
		return $this->db->get_where('portfolios', ['seo_title' => $seo_title])->row();
	}
	...
	{
		$this->db->update('portfolios', $data, ['id' => $id]);
   ...
   {
      $this->db->where('portfolios.is_active', 'Y');  
